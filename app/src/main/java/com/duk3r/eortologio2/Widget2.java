    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int i = 0; i < N; i++) {
			...
			*/
            ...
            Intent start_app = new Intent(context, Widget2.class);
            ...
            Intent change_day = new Intent(context, Widget2.class);
            ...
            Intent change_day1 = new Intent(context, Widget2.class);
            ...
            Intent change_day2 = new Intent(context, Widget2.class);

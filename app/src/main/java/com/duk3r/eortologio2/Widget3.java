...
public class Widget3 extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName thisWidget = new ComponentName(context, Widget3.class);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int i = 0; i < N; i++) {
			...
			*/
            ...
            Intent start_app = new Intent(context, Widget3.class);
            ...
            Intent change_day = new Intent(context, Widget3.class);
            ...
            Intent change_day1 = new Intent(context, Widget3.class);
            ...
            Intent change_day2 = new Intent(context, Widget3.class);

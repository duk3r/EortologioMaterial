...
public class LazyAdapterBday1 extends BaseAdapter{
    ...
    public LazyAdapterBday1(Context context,int txt_col) {
    ...
    public View getView(int index, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.bdaylist1, parent, false);
        }

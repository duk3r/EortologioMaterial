...
public class Widget extends AppWidgetProvider {
                ...
                if (app_preferences.getBoolean("notify1", true) == true) {
                    ...
                    if (mylist.size() > 0) {
                        ...
                        Notification notification = new Notification(
                                R.drawable.notification_small, tickerText, when);
                    ...
                    if (bdaysize > 0) {
                        ...
                        Notification notification1 = new Notification(
                                R.drawable.ic_launcher, tickerText, when1);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int i = 0; i < N; i++) {
			...
			// widget Font Size
			//int widget_text_size = 16;
			int widget_text_size = Integer.parseInt(app_preferences.getString("widget_text_size","16"));
			...
			*/
            ...
            Intent start_app = new Intent(context, Widget.class);
            ...
            Intent change_day = new Intent(context, Widget.class);
            ...
            Intent change_day1 = new Intent(context, Widget.class);
            ...
            Intent change_day2 = new Intent(context, Widget.class);

...
public class Eortes extends Activity {
    ...
    private LazyAdapterEortesList adapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eorteslistactivity);
        get_prefs();
        set_theme();
    ...
    public void onResume() {
        ...
        listView = (ListView) findViewById(R.id.eorteslistView1);
        adapter = new LazyAdapterEortesList(this);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                modify.setIcon(getResources().getDrawable(
                ...
                delete.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        UserDataBaseHelper BDBH = new UserDataBaseHelper(
                                getBaseContext());
                        ...
                        try {
                            db.execSQL("DELETE FROM user_table WHERE name=\""
                                    + name + "\" AND day=" + day
                                    + " AND month=" + month + ";");
                            Toast.makeText(getBaseContext(), "Επιτυχία",
                ...
                modify.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        qa.dismiss();
                        final Dialog dialog = new Dialog(Eortes.this);
                        ...
                        final WheelView day1 = (WheelView) dialog
                        ...
                        String months[] = new String[] { "Ιανουάριος",
                                "Φεβρουάριος", "Μάρτιος", "Απρίλιος", "Μάιος",
                                "Ιούνιος", "Ιούλιος", "Αύγουστος",
                                "Σεπτέμβριος", "Οκτώβριος", "Νοέμβριος",
                                "Δεκέμβριος" };
                        month1.setViewAdapter(new DateArrayAdapter(
                                getBaseContext(), months, curMonth));
                        ...
                        dialog.show();
                        Button mod = (Button) dialog
                                .findViewById(R.id.bdaylistmodify);
                        mod.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                SQLiteDatabase db = BDBH.getWritableDatabase();
                                try {
                                    db.execSQL("UPDATE user_table SET day="
                                            + dday + ",month=" + mmonth
                                            + " WHERE name=\"" + name
                                            + "\" AND day=" + day
                                            + " AND month=" + month + ";");
                                    Toast.makeText(getBaseContext(),
                                            "Επιτυχία", Toast.LENGTH_SHORT)
                                            .show();
                                    new LoadItemsTask2().execute();
    ...
    private class LoadItemsTask2 extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            items = ListData.getDatalist(ConRe, getApplicationContext());
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            editor.commit();
            if (items.size() == 0) {
                TextView action1textView5 = (TextView) findViewById(R.id.textVieweorteslist5);
            ...
            alarmManager.set(AlarmManager.RTC_WAKEUP, now.getTimeInMillis(),
                    pendingIntent);
        }
    }
    ...
    public void set_theme() {
        ...
        TextView tv1 = (TextView) findViewById(R.id.EortesListTextView1);
        TextView tv2 = (TextView) findViewById(R.id.textVieweorteslist5);

        tv1.setTextSize(text_size + title_text_size);
